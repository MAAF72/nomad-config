...
# Configure htaccess
curl "https://raw.githubusercontent.com/MAAF72/nomad-config/php-fpm-config/wordpress.htaccess" -o wordpress/.htaccess
...
curl "https://raw.githubusercontent.com/MAAF72/nomad-config/php-fpm-config/custom-wp-config.php" -o custom-wp-config.php
